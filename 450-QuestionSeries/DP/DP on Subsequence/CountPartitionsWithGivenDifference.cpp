...
int countPartitions(int d, vector<int>& arr){
    ...
    if((totSum-d)%2==1) return 0;   //IT HAS TO BE EVEN as we would have decimals if we divide by 2 
    
    int s2 = (totSum-d)/2;
        //FROM NOW IT IS SAME AS THE COUNT SUBSET SUM EQUAL TARGET PROBLEM
